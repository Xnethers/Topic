...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _Gloss ("Gloss", Range(0, 1)) = 0.5097656
        _Color_copy ("Color_copy", Color) = (0.6544118,0.8426978,1,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                return fixed4(_Color_copy.rgb,0);
            }
            ENDCG
        }
        Pass {
